            ...
            if (isset($_FILES['bannerimg']) && is_uploaded_file($_FILES['bannerimg']['tmp_name'])) {
                ...
                if (in_array($file_ext, $allowed_file_types)) {
                    ...
                    if (move_uploaded_file($_FILES['bannerimg']['tmp_name'], $target_file)) {
                        try {
                            $sql = "INSERT INTO bannerpage3 (banner_name, submission_date, start_date, expiry_date, path, image_url) VALUES (:bannername, :submissiondate, :startdate, :expirydate, :targetfile, :imageurl)";
                ...
                <div class="col-lg-12 col-md-12 mt-5">
                    <div class="card">
                        <div class="card-header border-botto">
                            <h3 class="card-title">Add Banner Page 3</h3>
                        </div>
                        <div class="card-body">
                            <form action="/forms/bannerpage3.php" method="post" enctype="multipart/form-data">
                                <div class="form-row">
